...
[![GitHub stars](https://img.shields.io/github/stars/lljud/nas-tools?style=plastic)](https://github.com/lljud/nas-tools/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/lljud/nas-tools?style=plastic)](https://github.com/lljud/nas-tools/network/members)
[![GitHub issues](https://img.shields.io/github/issues/lljud/nas-tools?style=plastic)](https://github.com/lljud/nas-tools/issues)
[![GitHub license](https://img.shields.io/github/license/lljud/nas-tools?style=plastic)](https://github.com/lljud/nas-tools/blob/master/LICENSE.md)
[![Docker pulls](https://img.shields.io/docker/pulls/lljud/nas-tools?style=plastic)](https://hub.docker.com/r/lljud/nas-tools)
[![Platform](https://img.shields.io/badge/platform-amd64/arm64-pink?style=plastic)](https://hub.docker.com/r/lljud/nas-tools)
...
[开发路线](https://github.com/lljud/nas-tools/discussions/91)
...
- [x] 持续更新索引站点
- [x] 更多功能请查阅 [版本发布](https://github.com/lljud/nas-tools/releases)  更新日志 

## 安装
### 1、Docker
```
docker pull lljud/nas-tools:latest
```
教程见 [这里](https://raw.githubusercontent.com/lljud/nas-tools/master/docker/readme.md) 。
...
```
git clone -b master https://github.com/lljud/nas-tools --recurse-submodule 
